...
SOURCES = [
    ...
    {
        "doc_id": "seed_unmod_tactics",
        "title": "Unmoderated Caucus Tactics",
        "doc_type": "training",
        "year": 2026,
        "path": SEED / "unmod_tactics.md",
        "kind": "markdown",
        "metadata": {"scope": "First unmod checklist, bloc-building, poaching defense, side deals, working paper logistics"},
        "quality_flag": "exemplary",
    },
    {
        "doc_id": "seed_research_framework",
        "title": "Country Research Framework",
        "doc_type": "training",
        "year": 2026,
        "path": SEED / "research_framework.md",
        "kind": "markdown",
        "metadata": {"scope": "Step-by-step country research process, sources, time allocation, common mistakes"},
        "quality_flag": "exemplary",
    },
    {
        "doc_id": "seed_crisis_directives_guide",
        "title": "Crisis Directives Guide",
        "doc_type": "training",
        "year": 2026,
        "path": SEED / "crisis_directives_guide.md",
        "kind": "markdown",
        "metadata": {"scope": "Directive anatomy, weak vs strong examples, personal vs press directives, backroom targeting"},
        "quality_flag": "exemplary",
    },
    {
        "doc_id": "seed_resolution_writing",
        "title": "Resolution Writing Guide",
        "doc_type": "training",
        "year": 2026,
        "path": SEED / "resolution_writing.md",
        "kind": "markdown",
        "metadata": {"scope": "Preambulatory and operative clause structure, phrases, sub-clauses, amendments, common mistakes"},
        "quality_flag": "exemplary",
    },
    {
        "doc_id": "seed_formal_debate_speaking",
        "title": "Formal Debate Speaking Guide",
        "doc_type": "training",
        "year": 2026,
        "path": SEED / "formal_debate_speaking.md",
        "kind": "markdown",
        "metadata": {"scope": "Speech structure, yields, right of reply, points of order, speakers list strategy"},
        "quality_flag": "exemplary",
    },
    {
        "doc_id": "seed_position_paper_guide",
        "title": "Position Paper Guide",
        "doc_type": "training",
        "year": 2026,
        "path": SEED / "position_paper_guide.md",
        "kind": "markdown",
